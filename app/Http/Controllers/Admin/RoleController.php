...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request , [
            ...
            'permission.*'=>'You Must a Select Permission'
        ...
        foreach ($request->permission as  $value) {
         ...
         return redirect()->action('Admin\RoleController@index')->with('success','Role Create Sussessfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($request->permission as  $value) {
         ...
         return redirect()->action('Admin\RoleController@index')->with('success','Role Updated Sussessfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->action('Admin\RoleController@index')->with('success','Role Deleted Sussessfully');
    }
}

...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'name.alpha_num'=>'This Field Accepts Alpha Numeric Charctar Only'
        ]);
        ...
        return redirect()->action('Admin\PermissionController@index')->with('success',"Permission Create Successfully");
    }
